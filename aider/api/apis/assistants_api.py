...
from aider.api.models.extra_models import TokenModel  # noqa: F401
...
from aider.api.security_api import get_token_ApiKeyAuth

router = APIRouter()

ns_pkg = aider.api.impl
...
async def cancel_run(
    ...
    ] = Path(..., description="The ID of the thread to which this run belongs."),
    run_id: Annotated[StrictStr, Field(description="The ID of the run to cancel.")] = Path(
...
async def create_run(
    thread_id: Annotated[StrictStr, Field(description="The ID of the thread to run.")] = Path(
    ...
    if not BaseAssistantsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseAssistantsApi.subclasses[0]().create_run(
        thread_id, create_run_request, include
    )
...
async def create_thread_and_run(
    ...
    if not BaseAssistantsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseAssistantsApi.subclasses[0]().create_thread_and_run(
...
async def delete_assistant(
    assistant_id: Annotated[
        StrictStr, Field(description="The ID of the assistant to delete.")
    ] = Path(..., description="The ID of the assistant to delete."),
    token_ApiKeyAuth: TokenModel = Security(get_token_ApiKeyAuth),
...
async def delete_message(
    ...
    ] = Path(..., description="The ID of the thread to which this message belongs."),
    message_id: Annotated[StrictStr, Field(description="The ID of the message to delete.")] = Path(
...
async def delete_thread(
    thread_id: Annotated[StrictStr, Field(description="The ID of the thread to delete.")] = Path(
...
async def get_assistant(
    ...
    ] = Path(..., description="The ID of the assistant to retrieve."),
    token_ApiKeyAuth: TokenModel = Security(get_token_ApiKeyAuth),
) -> AssistantObject:
    if not BaseAssistantsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
...
async def get_message(
    ...
    message_id: Annotated[
        StrictStr, Field(description="The ID of the message to retrieve.")
    ] = Path(..., description="The ID of the message to retrieve."),
    token_ApiKeyAuth: TokenModel = Security(get_token_ApiKeyAuth),
) -> MessageObject:
    if not BaseAssistantsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
...
async def get_run(
    ...
    ] = Path(..., description="The ID of the [thread](/docs/api-reference/threads) that was run."),
    run_id: Annotated[StrictStr, Field(description="The ID of the run to retrieve.")] = Path(
...
async def get_run_step(
    thread_id: Annotated[
        StrictStr, Field(description="The ID of the thread to which the run and run step belongs.")
    ] = Path(..., description="The ID of the thread to which the run and run step belongs."),
    run_id: Annotated[
        StrictStr, Field(description="The ID of the run to which the run step belongs.")
    ] = Path(..., description="The ID of the run to which the run step belongs."),
    step_id: Annotated[StrictStr, Field(description="The ID of the run step to retrieve.")] = Path(
...
async def get_thread(
    thread_id: Annotated[StrictStr, Field(description="The ID of the thread to retrieve.")] = Path(
...
async def list_messages(
    ...
    run_id: Annotated[
        ...
        None, description="Filter messages by the run ID that generated them. ", alias="run_id"
    ),
    token_ApiKeyAuth: TokenModel = Security(get_token_ApiKeyAuth),
) -> ListMessagesResponse:
    if not BaseAssistantsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseAssistantsApi.subclasses[0]().list_messages(
        thread_id, limit, order, after, before, run_id
    )
...
async def list_run_steps(
    ...
    ] = Path(..., description="The ID of the thread the run and run steps belong to."),
    run_id: Annotated[
        StrictStr, Field(description="The ID of the run the run steps belong to.")
    ] = Path(..., description="The ID of the run the run steps belong to."),
    limit: Annotated[
        Optional[StrictInt],
        Field(
            description="A limit on the number of objects to be returned. Limit can range between 1 and 100, and the default is 20. "
    ...
    if not BaseAssistantsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseAssistantsApi.subclasses[0]().list_run_steps(
        thread_id, run_id, limit, order, after, before, include
    )
...
async def list_runs(
    ...
    ] = Path(..., description="The ID of the thread the run belongs to."),
    limit: Annotated[
        Optional[StrictInt],
        Field(
            description="A limit on the number of objects to be returned. Limit can range between 1 and 100, and the default is 20. "
...
async def modify_assistant(
    assistant_id: Annotated[
        StrictStr, Field(description="The ID of the assistant to modify.")
    ] = Path(..., description="The ID of the assistant to modify."),
    modify_assistant_request: ModifyAssistantRequest = Body(None, description=""),
    token_ApiKeyAuth: TokenModel = Security(get_token_ApiKeyAuth),
) -> AssistantObject:
    if not BaseAssistantsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseAssistantsApi.subclasses[0]().modify_assistant(
        assistant_id, modify_assistant_request
    )
...
async def modify_message(
    ...
    message_id: Annotated[StrictStr, Field(description="The ID of the message to modify.")] = Path(
    ...
    if not BaseAssistantsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseAssistantsApi.subclasses[0]().modify_message(
        thread_id, message_id, modify_message_request
    )
...
async def modify_run(
    ...
    run_id: Annotated[StrictStr, Field(description="The ID of the run to modify.")] = Path(
...
async def modify_thread(
    thread_id: Annotated[
        StrictStr,
        Field(description="The ID of the thread to modify. Only the `metadata` can be modified."),
    ] = Path(
        ...,
...
async def submit_tool_ouputs_to_run(
    ...
    run_id: Annotated[
        StrictStr, Field(description="The ID of the run that requires the tool output submission.")
    ] = Path(..., description="The ID of the run that requires the tool output submission."),
    submit_tool_outputs_run_request: SubmitToolOutputsRunRequest = Body(None, description=""),
    token_ApiKeyAuth: TokenModel = Security(get_token_ApiKeyAuth),
) -> RunObject:
    if not BaseAssistantsApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseAssistantsApi.subclasses[0]().submit_tool_ouputs_to_run(
        thread_id, run_id, submit_tool_outputs_run_request
    )
