...
from aider.api.models.static_chunking_strategy_static import StaticChunkingStrategyStatic
        ...
        _obj = cls.model_validate(
            {
                "type": obj.get("type"),
                "static": (
                    StaticChunkingStrategyStatic.from_dict(obj.get("static"))
                    if obj.get("static") is not None
                    else None
                ),
            }
        )
