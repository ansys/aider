...
from aider.api.models.create_thread_request_tool_resources_file_search_vector_stores_inner import (
...
class CreateThreadRequestToolResourcesFileSearch(BaseModel):
    ...
    vector_stores: Optional[
        Annotated[
            List[CreateThreadRequestToolResourcesFileSearchVectorStoresInner], Field(max_length=1)
        ]
    ] = Field(
        default=None,
