...
from aider.api.models.run_step_details_tool_calls_code_object_code_interpreter_outputs_inner import (
        ...
        _obj = cls.model_validate(
            {
                ...
                "outputs": (
                    [
                        RunStepDetailsToolCallsCodeObjectCodeInterpreterOutputsInner.from_dict(
                            _item
                        )
