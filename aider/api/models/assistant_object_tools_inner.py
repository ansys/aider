...
from aider.api.models.assistant_tools_file_search import AssistantToolsFileSearch
from aider.api.models.assistant_tools_function import AssistantToolsFunction
...
ASSISTANTOBJECTTOOLSINNER_ONE_OF_SCHEMAS = [
    "AssistantToolsCode",
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        if not isinstance(v, AssistantToolsFileSearch):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `AssistantToolsFileSearch`"
            )
        else:
            match += 1
