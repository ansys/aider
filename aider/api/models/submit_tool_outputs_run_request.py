...
from aider.api.models.submit_tool_outputs_run_request_tool_outputs_inner import (
        ...
        _obj = cls.model_validate(
            {
                "tool_outputs": (
                    [
                        SubmitToolOutputsRunRequestToolOutputsInner.from_dict(_item)
                        for _item in obj.get("tool_outputs")
                    ]
