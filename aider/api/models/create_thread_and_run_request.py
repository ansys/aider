...
from aider.api.models.create_run_request_model import CreateRunRequestModel
...
from aider.api.models.create_thread_and_run_request_tool_resources import (
    CreateThreadAndRunRequestToolResources,
)
from aider.api.models.create_thread_and_run_request_tools_inner import (
...
class CreateThreadAndRunRequest(BaseModel):
    ...
    tools: Optional[Annotated[List[CreateThreadAndRunRequestToolsInner], Field(max_length=20)]] = (
        Field(
            default=None,
    ...
    response_format: Optional[AssistantObjectResponseFormat] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "thread": (
                    CreateThreadRequest.from_dict(obj.get("thread"))
                    if obj.get("thread") is not None
                    else None
                ),
                "model": (
                    CreateRunRequestModel.from_dict(obj.get("model"))
                ...
                "tools": (
                    [
                        CreateThreadAndRunRequestToolsInner.from_dict(_item)
