...
from aider.api.models.create_assistant_request_tool_resources_file_search_vector_stores_inner import (
...
class CreateAssistantRequestToolResourcesFileSearch(BaseModel):
    ...
    vector_stores: Optional[
        Annotated[
            List[CreateAssistantRequestToolResourcesFileSearchVectorStoresInner],
            Field(max_length=1),
        ]
    ] = Field(
        default=None,
        ...
        _obj = cls.model_validate(
            {
                ...
                "vector_stores": (
                    [
                        CreateAssistantRequestToolResourcesFileSearchVectorStoresInner.from_dict(
                            _item
                        )
