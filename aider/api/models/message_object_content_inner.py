...
from aider.api.models.message_content_image_file_object import MessageContentImageFileObject
from aider.api.models.message_content_image_url_object import MessageContentImageUrlObject
from aider.api.models.message_content_refusal_object import MessageContentRefusalObject
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        if not isinstance(v, MessageContentImageFileObject):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `MessageContentImageFileObject`"
            )
        else:
            match += 1
        ...
        if not isinstance(v, MessageContentImageUrlObject):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `MessageContentImageUrlObject`"
            )
        else:
            match += 1
        ...
        if not isinstance(v, MessageContentTextObject):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `MessageContentTextObject`"
            )
        else:
            match += 1
        ...
        if not isinstance(v, MessageContentRefusalObject):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `MessageContentRefusalObject`"
            )
        else:
            match += 1
        if match > 1:
