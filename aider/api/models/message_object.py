...
from aider.api.models.create_message_request_attachments_inner import (
    CreateMessageRequestAttachmentsInner,
)
from aider.api.models.message_object_content_inner import MessageObjectContentInner
from aider.api.models.message_object_incomplete_details import MessageObjectIncompleteDetails
...
class MessageObject(BaseModel):
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in (
            ...
            raise ValueError(
                "must be one of enum values ('in_progress', 'incomplete', 'completed')"
            )
        return value
        ...
        _obj = cls.model_validate(
            {
                ...
                "attachments": (
                    [
                        CreateMessageRequestAttachmentsInner.from_dict(_item)
                        for _item in obj.get("attachments")
                    ]
