...
from aider.api.models.create_message_request_attachments_inner_tools_inner import (
...
class CreateMessageRequestAttachmentsInner(BaseModel):
    ...
    file_id: Optional[StrictStr] = Field(
        default=None, description="The ID of the file to attach to the message."
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "tools": (
                    [
                        CreateMessageRequestAttachmentsInnerToolsInner.from_dict(_item)
