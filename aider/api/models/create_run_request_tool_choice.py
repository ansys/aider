...
from aider.api.models.assistants_named_tool_choice_function import AssistantsNamedToolChoiceFunction
...
class CreateRunRequestToolChoice(BaseModel):
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in (
            ...
            raise ValueError(
                "must be one of enum values ('function', 'code_interpreter', 'file_search')"
            )
        return value
